...
local settingsList = {
    ...
    set_tap_to_follow_links = {category="string", event="SetTapToFollowLinks", title=_("Tap to follow links"), reader=true, condition=Device:isTouchDevice(), args={true, false}, toggle={_("on"), _("off")}},
    set_larger_tap_area_to_follow_links = {category="string", event="SetLargerTapAreaToFollowLinks", title=_("Larger tap area around links"), reader=true, condition=Device:isTouchDevice(), args={true, false}, toggle={_("on"), _("off")}},
    set_footnote_link_in_popup = {category="string", event="SetFootnoteLinkInPopup", title=_("Show footnotes in popup"), reader=true, args={true, false}, toggle={_("on"), _("off")}},
    set_link_prefer_footnote = {category="string", event="SetLinkPreferFootnote", title=_("Show more links as footnotes"), reader=true, args={true, false}, toggle={_("on"), _("off")}},
    set_footnote_popup_japanese_support = {category="string", event="SetFootnotePopupJapaneseSupport", title=_("Footnote popup Japanese support"), reader=true, args={true, false}, toggle={_("on"), _("off")}},
    set_page_turns_disable_tap = {category="string", event="SetPageTurnsDisableTap", title=_("Disable page turns with taps"), reader=true, condition=Device:isTouchDevice(), args={true, false}, toggle={_("on"), _("off")}},
    set_activate_menu = {category="string", event="SetActivateMenu", title=_("Activate menu"), reader=true, condition=Device:isTouchDevice(), args={"swipe", "tap", "swipe_tap"}, toggle={_("swipe only"), _("tap only"), _("swipe and tap")}},
